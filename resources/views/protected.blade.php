{{--
  Template Name: Protected Content Earth Up Temples Page Template
--}}
@extends('layouts.app')
@section('content')
  @while(have_posts()) @php the_post() @endphp
    ...
    <div class="body-wrap">
     ...
     <div class="exclusive-content-logged-out">
      ...
      <p>
        You must be logged in and be a member of the earth temple or higher to view the contents of this page. To login and gain access, you need to be a member of the community.
      </p>
      <p>
