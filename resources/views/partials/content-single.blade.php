<?php 
  if ( ! is_singular( 'exclusive-content' ) ) {
 ?>
      ...
      ?>
        <div class="body-wrap">
          <div class="exclusive-content-logged-out">
            <h2>
              This page contains exsclusive content
            </h2>
            <h2>
              <?php echo $earth_up; ?>
            </h2>
            <p>
              You must be logged in to view the contents of this page. To login and gain access, you need to be a member of the community.
            </p>
            <p>
